...
export default function QuestionGenerator() {
  ...
  <div className="bg-white border-2 border-yellow-300 shadow-lg rounded-xl p-5 flex flex-col col-span-3 overflow-hidden">
          ...
          <div className="mt-2 flex items-center space-x-3">
            ...
            {/* ID display removed per UX request */}
          </div>

          <div className="mt-3 overflow-auto flex-1">
            <div className="p-3 bg-yellow-50 rounded-md border-2 border-yellow-300">
              {question ? (
  ...
  {/* Right lower: Split Hint and Solution into two separate rectangles */}
  <div className="col-span-3 grid grid-cols-1 md:grid-cols-2 gap-4">
    {/* Hint Card */}
    <div className="bg-white border-2 border-indigo-300 shadow-lg rounded-xl p-5 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-4 bg-indigo-50 rounded-md border-2 border-indigo-200 min-h-[180px] text-indigo-900">
          {hint ? (
            <p className="whitespace-pre-wrap">{hint}</p>
          ) : (
            <p className="text-indigo-400">Hint will appear here.</p>
          )}
        </div>
      </div>
    </div>
    ...
    <div className="bg-white border-2 border-green-300 shadow-lg rounded-xl p-5 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto">
        {solutionSteps && solutionSteps.length > 0 ? (
          <ol className="list-decimal list-inside space-y-4 bg-green-50 p-5 rounded-md border-2 border-green-300 shadow-inner min-h-[180px]">
          ...
          <div className="p-5 rounded-md border-2 border-green-200 bg-green-50 min-h-[180px] text-green-600">
      ...
      <div className="mt-3">
        ...
        <div className="mt-2">
          ...
          {feedback && (
            <div className="text-sm font-medium text-gray-700 mt-2 p-2 bg-blue-50 rounded-md border-2 border-blue-200">
              {feedback}
            </div>
          )}
        </div>
